...
// @ts-ignore
export function appTemplateHtml(this: App) {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h4',[_vm._v("Log Tool")]),_vm._v(" "),_c('tab-container',{attrs:{"data":_vm.data},on:{"switching":function($event){return _vm.switching($event)}}})],1)}
// @ts-ignore
export var appTemplateHtmlStatic = [  ]
// @ts-ignore
export function othersTemplateHtml(this: Others) {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"panel"},[_c('button',{staticClass:"btn btn-primary",on:{"click":function($event){return _vm.resaveFailedLogs()}}},[_vm._v("resave failed logs")])])}
// @ts-ignore
